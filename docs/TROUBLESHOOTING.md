# 🔧 Troubleshooting Guide — DataOps Studio
...
2. **Check official documentation:**
   - [GitHub Issues for this repo](https://github.com/Pradeeptalari14/tp-dataops/issues)
   - [Studio FAQ](https://pradeeptalari14.github.io/portfolio/tools/dataops/)
